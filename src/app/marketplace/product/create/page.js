...
/*<div className="flex h-screen bg-[url('/login_bg_v.png')] md:bg-[url('/login_bg.png')] bg-cover justify-center items-center overflow-hidden">
            <div className="flex bg-black/70 h-full w-full justify-center items-center p-6">
                <div className="flex flex-col bg-white bg-opacity-90 rounded-lg shadow-lg p-6 space-y-4 md:w-[50%] h-full md:max-h-[98vh] overflow-auto">
                    <p className="text-3xl font-extrabold md:text-center text-black py-2">Add a New Rental Item</p>
